...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap -->
    <link href="../templates/vendors/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet" media="screen" >
    <!-- Font Awesome -->
    <link href="../templates/vendors/font-awesome/css/font-awesome.min.css" rel="stylesheet" media="screen" >

    <!-- Custom Theme Style --> 
    <link href="../templates/build/css/custom.min.css" rel="stylesheet" media="screen" >
    <!-- hero clock -->
