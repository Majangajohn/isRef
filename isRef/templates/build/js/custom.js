...
const countySelector = document.getElementById("schoolcounty")
...
countySelector.addEventListener('change', function(){
	...
	$.ajax({
	    type: "GET",
	    url: "http://localhost/LBDA/main/schoolsentry.php",
	    data: {
	    	county: county
	    },
...
const subcountyselector = document.getElementById("schoolsubcounty");
...
subcountyselector.addEventListener('change', function(){
	...
	$.ajax({
	    ...
	    success: function(result){
	        ...
	        const constituencySelect = document.getElementById("schoolconstituency")
...
const constituencyselector = document.getElementById("schoolconstituency");
...
constituencyselector.addEventListener('change', function(){
	...
	$.ajax({
	    ...
	    success: function(result){
	        ...
	        const wardSelect = document.getElementById("schoolward")
