...
categorySelector.addEventListener('change', function(){
	...
	$.ajax({
	    type: "GET", 
	    url: "http://localhost/LBDA/main/administrationcapture.php",
	    data: {
	    	category: category
		}, 
		success: function(results){
			window.location.href = 'administrationcapture.php'
		},
...
const subcountyselector = document.getElementById("subcounty");
