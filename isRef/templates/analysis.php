                        ...
                        <div class="row">
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Projects undertaken</div>
                            ...
                            <div class="card border-left-success shadow h-100 py-2">
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Trees Planted</div>
                        ...
                        <div class="row">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="dropdown no-arrow">
                                    ...
                                    <i class="fa fa-ellipsis-v fas-sm fa-fw text-gray-400"></i>
                                    </a>
